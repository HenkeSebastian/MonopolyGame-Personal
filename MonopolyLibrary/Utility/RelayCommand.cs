...
namespace MonopolyLibrary.Utility
{
    public class RelayCommand<T> : ICommand
    {
        ...
        readonly Action _altExecute = null;
        private object _destinationPage;
        ...
        public RelayCommand(Action<T> execute, object destinationPage = null)
            : this(execute, null, destinationPage)
        {
        }
        ...
        private RelayCommand(Action<T> execute, Predicate<T> canExecute, object destinationPage)
        {
            if (execute == null)
                throw new ArgumentNullException("execute");
